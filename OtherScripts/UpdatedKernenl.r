...
base_path_to_matrix <- "C:/ShareSSD/scop/values_"
base_path_to_result <- "C:/ShareSSD/scop/data/kde_"
base_path_to_stats <- 'C:/ShareSSD/scop/data/stats_'
sample = 'b.2.'
#measures = c('rmsd','gdt_2','gdt_4','tmscore_high','tmscore_low','maxsub_high','maxsub_low','seq_id') 
measures = c('rmsd','gdt_2','gdt_4') 
